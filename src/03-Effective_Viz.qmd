...
knitr::include_graphics(here("images", "badviz3.png"))
```
...
knitr::include_graphics(here("images", "trilogies.png"))
```
...
knitr::include_graphics(here("images", "chernoff.png"))
```
...
knitr::include_graphics(here("images", "badviz2.png"))
```
...
knitr::include_graphics(here("images", "obama1.png"))
```
...
knitr::include_graphics(here("images", "breakup.png"))
```
...
knitr::include_graphics(here("images", "heatmap.png"))
```
...
knitr::include_graphics(here("images", "badviz1.png"))
```
...
knitr::include_graphics(here("images", "slopegraph1.png"))
```
...
knitr::include_graphics(here("images", "piechart.png"))
```
...
knitr::include_graphics(here("images", "Nightingale.png"))
```
...
knitr::include_graphics(here("images", "compensation.png"))
```
...
knitr::include_graphics(here("images", "employees.png"))
```
...
knitr::include_graphics(here("images", "clutter.png"))
```
...
knitr::include_graphics(here("images", "badviz4.png"))
```
...
knitr::include_graphics(here("images", "plagiarism.png"))
```
...
knitr::include_graphics(here("images", "tv-size-by-year1.png"))
```
...
knitr::include_graphics(here("images", "colorblind.jpg"))
```
...
knitr::include_graphics(here("images", "contrast.png"))
```
...
knitr::include_graphics(here("images", "rose1.png"))
```
...
knitr::include_graphics(here("images", "gestalt.png"))
```
