...
knitr::include_graphics(here("images", "pivot_wider.png"))
```
...
knitr::include_graphics(here("images", "pivot_longer.png"))
```
...
DailyGroups <- read_csv(here("data", "daily-group-assignment.csv"))
Daily <- Daily %>%
  inner_join(DailyGroups, by = c("group" = "group"))
```
