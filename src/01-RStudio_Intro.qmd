...
```{example, name="Assigning Values to Variables", label="assignment"}
...
```{example, name="Units of Observation and Variables"}
...
```{example, name="Importing Package Data"}
...
```{example, name="Examining Data Structures"}
...
```{example, name="Examining a Single Variable"}
...
```{example name="Deduce the R Markdown Format"}
